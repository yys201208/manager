  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="teacherName" label="管理员"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="desc" label="分类描述">
          <el-input type="textarea" :rows="5" v-model="form.descr" autocomplete="off"></el-input>
        <el-form-item prop="teacherId" label="选择管理员">
          <el-select v-model="form.teacherId" placeholder="请选择实验室管理员" style="width: 100%">
