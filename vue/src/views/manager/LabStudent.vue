<template>
  <div>
    <div class="search">
      <el-select v-model="typeId" placeholder="请选择实验室分类查询" style="width: 200px">
        <el-option v-for="item in typeData" :label="item.name" :value="item.id"> </el-option>
      </el-select>
      <el-input placeholder="请输入实验室编号查询" style="width: 200px;margin-left: 10px" v-model="name"></el-input>
