<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入实验室名称查询" style="width: 200px" v-model="name"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="descr" label="实验室描述" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="descr" label="实验室描述">
        ...
        <el-form-item prop="typeId" label="实验室分类" style="width: 100%">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          {required: true, message: '请输入实验室分类', trigger: 'blur'},
        ],
        teacherId: [
